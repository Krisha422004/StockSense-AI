...
def get_stock_quote(symbol):
    ...
    try:
        ...
        # 1. VALIDATION: fetch 1 day of history. 
        ...
        # Check for zero/NaN cases which can happen with delisted stocks
...
def get_market_news():
    ...
    try:
        ...
        return response.json()[:5] # Limiting to top 5 for the sidebar
    except Exception as e:
